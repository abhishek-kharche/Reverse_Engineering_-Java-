...
public class MainGUI extends JFrame {
	...
	private static int selectLayout = 3;

	/**
	 * @uml.property  name="destinationPathButton"
	 * @uml.associationEnd  
	 */
	private JButton destinationPathButton;
	/**
	 * @uml.property  name="startProcessButton"
	 * @uml.associationEnd  
	 */
	private JButton startProcessButton;
	/**
	 * @uml.property  name="removeSelectedImagesButton"
	 * @uml.associationEnd  
	 */
	private JButton removeSelectedImagesButton;
	/**
	 * @uml.property  name="removeAllImagesButton"
	 * @uml.associationEnd  
	 */
	private JButton removeAllImagesButton;
	/**
	 * @uml.property  name="openImageListButton"
	 * @uml.associationEnd  
	 */
	private JButton openImageListButton;
	/**
	 * @uml.property  name="saveImageListButton"
	 * @uml.associationEnd  
	 */
	private JButton saveImageListButton;
	/**
	 * @uml.property  name="exportImageListButton"
	 * @uml.associationEnd  
	 */
	private JButton exportImageListButton;
	/**
	 * @uml.property  name="moveUpButton"
	 * @uml.associationEnd  
	 */
	private JButton moveUpButton;
	/**
	 * @uml.property  name="moveDownButton"
	 * @uml.associationEnd  
	 */
	private JButton moveDownButton;
	/**
	 * @uml.property  name="openImageViewerButton"
	 * @uml.associationEnd  
	 */
	private JButton openImageViewerButton;
	/**
	 * @uml.property  name="moveToTopButton"
	 * @uml.associationEnd  
	 */
	private JButton moveToTopButton;
	/**
	 * @uml.property  name="moveToBottomButton"
	 * @uml.associationEnd  
	 */
	private JButton moveToBottomButton;

	/**
	 * @uml.property  name="destinationPathLabel"
	 * @uml.associationEnd  
	 */
	private JLabel destinationPathLabel;
	/**
	 * @uml.property  name="subFolderLabel"
	 * @uml.associationEnd  
	 */
	private JLabel subFolderLabel;
	/**
	 * @uml.property  name="subFolderPreviewTextFieldLabel"
	 * @uml.associationEnd  
	 */
	private JLabel subFolderPreviewTextFieldLabel;
	/**
	 * @uml.property  name="fileNameTemplateLabel"
	 * @uml.associationEnd  
	 */
	private JLabel fileNameTemplateLabel;
	/**
	 * @uml.property  name="infoPanelLabel"
	 * @uml.associationEnd  
	 */
	private JLabel infoPanelLabel;
	/**
	 * @uml.property  name="amountOfImagesInImageListLabel"
	 * @uml.associationEnd  
	 */
	private JLabel amountOfImagesInImageListLabel;
	/**
	 * @uml.property  name="imagePreviewLabel"
	 * @uml.associationEnd  
	 */
	private JLabel imagePreviewLabel;

	/**
	 * @uml.property  name="destinationPathTextField"
	 * @uml.associationEnd  
	 */
	private JTextField destinationPathTextField;
	/**
	 * @uml.property  name="subFolderTextField"
	 * @uml.associationEnd  
	 */
	private JTextField subFolderTextField;
	/**
	 * @uml.property  name="fileNameTemplateTextField"
	 * @uml.associationEnd  
	 */
	private JTextField fileNameTemplateTextField;
	/**
	 * @uml.property  name="subFolderNamePreviewTextField"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="configGUIJMenuItem"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem configGUIJMenuItem;
	/**
	 * @uml.property  name="shutDownProgramJMenuItem"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem shutDownProgramJMenuItem;
	/**
	 * @uml.property  name="openDestinationFileChooserJMenuItem"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem openDestinationFileChooserJMenuItem;
	/**
	 * @uml.property  name="startProcessJMenuItem"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem startProcessJMenuItem;
	/**
	 * @uml.property  name="helpJMenuItem"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem helpJMenuItem;
	/**
	 * @uml.property  name="aboutJMenuItem"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem aboutJMenuItem;
	/**
	 * @uml.property  name="popupMenuAddImageToViewList"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem popupMenuAddImageToViewList;
	/**
	 * @uml.property  name="popupMenuAddAllImagesToViewList"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JMenuItem popupMenuAddAllImagesToViewList;

	/**
	 * @uml.property  name="rightClickMenu"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JPopupMenu rightClickMenu;

	/**
	 * @uml.property  name="thumbNailsPanel"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="thumbNailMetaPanelSplitPane"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	...
	/**
	 * @uml.property  name="createThumbNailsCheckBox"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="mainTabbedPane"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	...
	/**
	 * @uml.property  name="previewTable"
	 * @uml.associationEnd  
	 */
	 ...
	 * @uml.associationEnd  inverse="this$0:moller.javapeg.program.MainGUI$Mouselistener"
	 */
	private Mouselistener mouseListener;
	/**
	 * @uml.property  name="mouseRightClickButtonListener"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:moller.javapeg.program.MainGUI$MouseButtonListener"
	 */
	...
	/**
	 * @uml.property  name="columnMargin"
	 */
	private int columnMargin = 0;

	/**
	 * @uml.property  name="thumbNailGridLayout"
	 */
	...
	/**
	 * @uml.property  name="thumbNailsBackgroundsPanel"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private JPanel thumbNailsBackgroundsPanel;

	/**
	 * @uml.property  name="metaDataTableModel"
	 * @uml.associationEnd  
	 */
	private MetaDataTableModel metaDataTableModel;
	/**
	 * @uml.property  name="previewTableModel"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="imageMetaDataPanel"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
	private MetaDataPanel imageMetaDataPanel;

	/**
	 * @uml.property  name="thumbNailListener"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:moller.javapeg.program.MainGUI$ThumbNailListener"
	 */
	private ThumbNailListener thumbNailListener;

	/**
	 * @uml.property  name="imagesToViewListModel"
	 * @uml.associationEnd  
	 */
	private DefaultListModel imagesToViewListModel;

	/**
	 * @uml.property  name="imagesToViewList"
	 * @uml.associationEnd  
	 */
	...
	private JScrollPane createThumbNailsBackgroundPanel(){
		...
		//if (selectLayout ==0)
			thumbNailsPanel.setLayout(temp);
...
/*
				...
				*/		
						...
						items++;
						//thumbContainer.setBorder(null);
						thumbContainer.setBorderPainted(false);
						//thumbContainer.setFocusPainted(false);
						thumbContainer.setMargin(new Insets(1,1,1,1));
